...
int main(int argc, char* argv[])
{
  ...
  //
  // run intialization, over nMCS=100, nRuns=1
  //
  ...
  //
  // set reactivity of star ends (no, performed later)
  //
  ...
  //
  // write complete initialization to bfm file
  //
  ...
  taskManager.addAnalyzer(new AnalyzerWriteBfmFile<IngredientsType>("config_last_100_stars_73_97.bfm",ingredients,AnalyzerWriteBfmFile<IngredientsType>::OVERWRITE));
  ...
  //
  // connect branch ends of different types A and B 
  //
  ...
  //
  // set reactivity of branch ends, with different sizes of A stars and B stars
  //
  ...
  uint32_t icontrol=1;  // jumps to shorter variant
  ...
  //
  // run UpdaterSimpleSimulator over nMCS=100, nRuns=100 (up to 10000)
  // randomizes star geometries with respect to geometry while creating stars
  //
  ...
  //
  // run UpdaterSimpleConnection over nMCS=100, nRuns=100 (10000 to 20000)
  //
  ...
  //taskManager3.addUpdater(new UpdaterSetReactivityStarEndsAB<IngredientsType,MoveLocalSc,MoveConnectSc>(ingredients,0),0); 
  
  //taskManager3.addUpdater(new UpdaterSimpleSimulator<IngredientsType,MoveLocalSc>(ingredients,nMCS));

  //taskManager3.addUpdater(new UpdaterSimpleConnection<IngredientsType,MoveLocalSc,MoveConnectSc>(ingredients,nMCS));
  taskManager3.addUpdater(new UpdaterSimpleConnectionAB<IngredientsType,MoveLocalSc,MoveConnectScAB>(ingredients,nMCS));
  
  taskManager3.addAnalyzer(new 
  AnalyzerWriteBfmFile<IngredientsType>("config_ev_100_stars_73_97.bfm",ingredients,AnalyzerWriteBfmFile<IngredientsType>::APPEND));

  taskManager3.addAnalyzer(new AnalyzerWriteBfmFile<IngredientsType>("config_last_100_stars_73_97.bfm",ingredients,AnalyzerWriteBfmFile<IngredientsType>::OVERWRITE));
