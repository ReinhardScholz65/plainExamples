...
#ifndef LEMONADE_UPDATER_SETREACTIVITYSTARENDSAB_H
#define LEMONADE_UPDATER_SETREACTIVITYSTARENDSAB_H
 ...
 * @file
 *
 * @class UpdaterSetReactivityStarEndsAB
 *
...
class UpdaterSetReactivityStarEndsAB:public AbstractUpdater
{
...
//  UpdaterSetReactivityStarEndsAB(IngredientsType& ing,uint32_t steps = 1 )
  UpdaterSetReactivityStarEndsAB(IngredientsType& ing,uint32_t steps = 1 )
 ...
 */
template<class IngredientsType,class MoveType, class ConnectionMoveType>
bool UpdaterSetReactivityStarEndsAB<IngredientsType,MoveType,ConnectionMoveType>::execute()
{
...
template<class IngredientsType,class MoveType, class ConnectionMoveType>
void  UpdaterSetReactivityStarEndsAB<IngredientsType,MoveType,ConnectionMoveType>::initialize()
{
...
#endif 	/*LEMONADE_UPDATER_SETREACTIVITYSTARENDSAB_H*/
