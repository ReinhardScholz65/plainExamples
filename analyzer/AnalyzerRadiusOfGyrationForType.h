...
#ifndef LEMONADE_ANALYZER_RADIUS_OF_GYRATION_FOR_TYPE_H
#define LEMONADE_ANALYZER_RADIUS_OF_GYRATION_FOR_TYPE_H
...
/*************************************************************************
 * definition of AnalyzerRadiusOfGyrationForType class
 * ***********************************************************************/

/**
 * @file
 *
 * @class AnalyzerRadiusOfGyrationForType
 *
 ...
 * also write a new analyzer, inheriting from AnalyzerRadiusOfGyrationForType, and
 * overwriting the initialize function.
 */
template < class IngredientsType > class AnalyzerRadiusOfGyrationForType : public AbstractAnalyzer
{
...
public:
	...
	//! constructor
	AnalyzerRadiusOfGyrationForType(const IngredientsType& ing,
			  std::string filename="Rg2TimeSeries.dat", int type_ = 1 );

	//! destructor. does nothing
	virtual ~AnalyzerRadiusOfGyrationForType(){}
...
AnalyzerRadiusOfGyrationForType<IngredientsType>::AnalyzerRadiusOfGyrationForType(
	const IngredientsType& ing,
	std::string filename, int type_ )
:ingredients(ing)
 ...
 * */
template< class IngredientsType >
void AnalyzerRadiusOfGyrationForType<IngredientsType>::initialize()
{
	...
	if(groups.size()==0){
        ...
        {
            if (ingredients.getMolecules()[n].getAttributeTag()== type )
 ...
 * */
template< class IngredientsType >
bool AnalyzerRadiusOfGyrationForType<IngredientsType>::execute()
{
...
template<class IngredientsType>
void AnalyzerRadiusOfGyrationForType<IngredientsType>::cleanup()
{
	std::cout<<"AnalyzerRadiusOfGyrationForType::cleanup()...";
 ...
 * */
template<class IngredientsType>
void AnalyzerRadiusOfGyrationForType<IngredientsType>::dumpTimeSeries()
{
	...
	if(isFirstFileDump){
		...
		commentTimeSeries<<"Created by AnalyzerRadiusOfGyrationForType\n";
 ...
 * */
template<class IngredientsType>
VectorDouble3 AnalyzerRadiusOfGyrationForType<IngredientsType>::calculateRg2Components(
